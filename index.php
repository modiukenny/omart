...
<head>
	...
	<meta name="author" content="Omart">
	<meta name="description" content="Transform your ideas into captivating designs, bring them to life with high-quality 
				...
				<ul class="navbar-nav navbar-nav-scroll dropdown-hover mx-auto">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu">
							...
							<!-- Dropdown submenu -->
							<li class="dropdown dropend">
								<a class="nav-link dropdown-link dropdown-toggle" data-bs-toggle="dropdown" href="#">Gift Items</a>
								<ul class="dropdown-menu" data-bs-popper="none">
									<li class="dropdown dropend">
		...
		<div class="row g-4 g-sm-5 g-xl-7 mt-0">
			...
			<div class="col-md-6 col-lg-4">
				<article class="card bg-transparent h-100 p-0">
					<!-- Badge -->
					<div class="badge text-bg-dark position-absolute top-0 start-0 m-3">Print</div>

					<!-- Card image -->
					<img src="assets/images/blog/4by4/businesscard.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/paper-bag.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/pen.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/sticker.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/letterhead.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/id-card.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/roll-up.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/t-shirt.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		<!-- Badge -->
		<div class="badge text-bg-dark position-absolute top-0 start-0 m-3">Graphic Design</div>

		<!-- Card image -->
		<img src="assets/images/blog/4by4/logo.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/graphic-design.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/lanyard.jpg" class="card-img" alt="Blog-img">
...
<div class="col-md-6 col-lg-4">
	<article class="card bg-transparent h-100 p-0">
		...
		<!-- Card image -->
		<img src="assets/images/blog/4by4/jotter.jpg" class="card-img" alt="Blog-img">
	...
	<div class="container position-relative mt-5">
		<div class="row g-4 justify-content-between">
			...
			<div class="col-lg-3">
				...
				<p class="mt-4 mb-2">Transform your ideas into captivating designs, bring them to life with high-quality 
					printing, and build a strong, memorable brand that resonates with your audience.</p>
			</div>
			<!-- Widget 1 END -->
				...
				<div class="row g-4">
					...
					<div class="col-6 col-md-4">
						...
						<ul class="nav flex-column">
							<li class="nav-item"><a class="nav-link pt-0 text-warning" href="#">Home</a></li>
							<li class="nav-item"><a class="nav-link pt-0" href="aboutus">About us</a></li>
							<li class="nav-item"><a class="nav-link" href="contact">Contact us</a></li>
						</ul>
					</div>
					...
					<div class="col-6 col-md-4">
						...
						<ul class="nav flex-column">
							<li class="nav-item"><a class="nav-link pt-0" href="mailto:omartcreativity@gmail.com">omartcreativity<br>@gmail.com</a></li>
							<li class="nav-item"><a class="nav-link" href="tel:+2349036540171">+234 903 6540 171</a>   
								<a class="nav-link" href="tel:+2348125070170">+234 812 5070 170</a></li>
						</ul>
					</div>
					...
					<div class="col-md-4">
						...
						<ul class="list-inline mb-0 mt-3">
							<li class="list-inline-item"> <a class="btn btn-xs btn-icon btn-light-soft" href="https://www.facebook.com/OmartCr8tivity?mibextid=LQQJ4d"><i class="fab fa-fw fa-facebook-f lh-base"></i></a> </li>
							<li class="list-inline-item"> <a class="btn btn-xs btn-icon btn-light-soft" href=" https://www.instagram.com/omartcr8tivity_/profilecard/?igsh=MTdvdmM3am1vb2w3cA=="><i class="fab fa-fw fa-instagram lh-base"></i></a> </li>
							<li class="list-inline-item"> <a class="btn btn-xs btn-icon btn-light-soft" href="https://youtube.com/@omartcr8tivity?si=YokaJkdsOryli0lS"><i class="fab fa-fw fa-youtube lh-base"></i></a> </li>
						</ul>
					</div>
				</div>
			</div>
		...
		<div class="d-md-flex justify-content-between align-items-center text-center text-lg-start py-4">
			<!-- copyright text -->
			<div class="text-body"> Copyrights ©2024 Omart. Build by <a href="https://www.hazken.com/" class="text-body text-primary-hover">Hazken Digital</a> </div>
			<!-- copyright links-->
...
<div class="fi-whatsapp">
 <li class="list-inline-item"> <a class="text-white" href="https://wa.me/2348125070170"><i class="fab fa-fw fa-whatsapp lh-base"></i></a> </li>
</div>
<!-- Back to top -->
...
<!-- Mirrored from mizzle.webestica.com/blog-grid.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Dec 2024 15:12:37 GMT -->
</html>